...
1. What is the purpose of using _sessions_? Allowing users to still be logged in for a period of time after they close the browser
1. What does bcrypt do to help us store passwords in a secure manner. It hashes the passwords
